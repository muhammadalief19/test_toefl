                                                            ...
                                                            <form action="{{ route('forum.update', $item->_id) }}"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        id="forum_name" name="forum_name"
                                                                        value="{{ $item->forum_name }}" autocomplete="off" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="description">Nama Forum</label>
                                                                    <input type="text" class="form-control"
...
@section('modal')
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-center">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="addModalLabel">Forum Baru</h1>
                ...
                <div class="modal-body">
                    <form action="{{ route('forum.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            <label for="forum_name">Nama Forum</label>
                            <input class="form-control" type="text" name="forum_name" id="forum_name" autocomplete="off" required>
                        </div>
                        <div class="form-group">
...
@push('scripts')
    <script src="{{ asset('templates/vendor/wow-master/dist/wow.min.js') }}templates/vendor/wow-master/dist/wow.min.js"></script>
    <script>
