      ...
      <nav class="navbar navbar-expand">
        <div class="collapse navbar-collapse justify-content-between">
          <div class="header-left">
            <div class="dashboard_bar">{{ $data["title"] }}</div>
          </div>
          <ul class="navbar-nav header-right">
                ...
                <div class="card mb-0">
                  <div class="card-header border-0 d-block h-auto">
                    ...
                    >
                      ...
                      <li class="nav-item dropdown notification_dropdown">
                        <a
                          class="nav-link bell dz-fullscreen"
                          href="javascript:void(0);"
                        >
                          <svg
                            id="icon-full"
            ...
            <li
              class="nav-item dropdown notification_dropdown search-area-header"
            >
              <a
                class="nav-link"
                href="javascript:void(0);"
                  ...
                  <div class="card-body px-0">
                    ...
                    <div class="dlab-scroll px-3 mt-3 height300">
                      <ul class="d-flex align-items-center mb-3">
                        <li>
                          <img
                            src="{{ asset('templates/images/avatar/1.jpg') }}"
                      ...
                      <ul class="d-flex align-items-center mb-3">
                        <li>
                          <img
                            src="{{ asset('templates/images/avatar/2.jpg') }}"
                            class="avatar avatar-sm"
                            alt=""
                          />
                          <a href="javascript:void(0);" class="ms-2"
                      ...
                      <ul class="d-flex align-items-center mb-3">
                        <li>
                          <img
                            src="{{ asset('templates/images/avatar/4.jpg') }}"
                            class="avatar avatar-sm"
                            alt=""
                          />
                          <a href="javascript:void(0);" class="ms-2"
                      ...
                      <ul class="d-flex align-items-center mb-3">
                        <li>
                          <img
                            src="{{ asset('templates/images/avatar/3.jpg') }}"
                            class="avatar avatar-sm"
                            alt=""
                          />
                          <a href="javascript:void(0);" class="ms-2"
            ...
            <li
              class="nav-item bell-icon blink dropdown notification_dropdown"
            >
              <a
                class="nav-link"
                href="javascript:void(0);"
              ...
              <div class="dropdown header-profile2">
                ...
                >
                  <div class="header-info2 d-flex align-items-center">
                    <div
                      class="d-flex align-items-center sidebar-info"
                    ></div>
                    <img src="{{ asset('templates/images/avatar/1.png') }}" alt="" />
                  </div>
                </a>
                  ...
                  <div class="card mb-0">
                    <div class="card-header p-3">
                      <ul class="d-flex align-items-center">
                        <li>
                          <img src="{{ asset('templates/images/avatar/1.png') }}" class="ms-0" alt="" />
                        </li>
                        <li class="ms-2">
                          <h4 class="mb-0">{{ Auth::user()->name }}</h4>
                          <span>{{ ucfirst(Auth::user()->role->role_name) }}</span>
                        </li>
                      </ul>
                    </div>
